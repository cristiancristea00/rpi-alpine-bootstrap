...
info "  tor-snowflake-proxy-start      - Start Snowflake proxy"
info "  tor-snowflake-proxy-stop       - Stop Snowflake proxy"
info "  tor-snowflake-proxy-restart    - Restart Snowflake proxy"
info ""
